...
# 2 "mcc_generated_files/mylib.h" 2
...
void TMR0_ISR(void)
{
    ...
    if(tmr0Cnt % 50 == 0) thermoTimer.T_chkBattery = 2;

    if(thermoTimer.T_chkMode == 1 )
    {
        if(thermoTimer.chkModeCnt++ == 50)
        {
            thermoTimer.T_chkMode = 2;
            thermoTimer.chkModeCnt = 0;
        }
    }
    if(thermoTimer.T_chkTest == 1 )
    {
        if(thermoTimer.chkTestCnt++ == 20)
        {
            thermoTimer.T_chkTest = 2;
            thermoTimer.chkTestCnt = 0;
        }
    }
    if(thermoTimer.T_chkSilent == 1 )
    {
        if(thermoTimer.chkSilentCnt++ == 250)
        {
            thermoTimer.T_chkSilent = 2;
