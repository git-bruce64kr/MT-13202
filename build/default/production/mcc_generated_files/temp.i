...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/temp.c" 2
...
# 9 "mcc_generated_files/temp.c" 2
...
double calObjTemp()
{
    ...
    adc_result_t result = getTempFromSensor(0);
    if(result >= 1381)
    {
        result = result - 1381;
...
double calAmbTemp()
{
    ...
    adc_result_t result = getTempFromSensor(1);
    if(result <= 2048 )
    {
        Tcalamb = 2048 - result;
        if( Tcalamb <= 224) Tamb = Tcalamb/44.7564;
        ...
        if(Tcalamb > 807 && Tcalamb <= 966) Tamb = Tcalamb/38.6570;
        ...
        if(Tcalamb > 1521 && Tcalamb <= 1592) Tamb = Tcalamb/28.9457;
    ...
    if(result > 2048 )
    {
        ...
        if(Tcalamb > 234 && Tcalamb <= 460) Tamb = Tcalamb/46.0280;
        if(Tcalamb > 460 && Tcalamb <= 677) Tamb = Tcalamb/45.1180;
        if(Tcalamb > 677 && Tcalamb <= 884) Tamb = Tcalamb/44.2000;
        if(Tcalamb > 884 && Tcalamb <= 1082) Tamb = Tcalamb/43.2876;
