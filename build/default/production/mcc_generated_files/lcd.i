...
# 51 "mcc_generated_files/lcd.c" 2

# 1 "mcc_generated_files/lcd.h" 1
# 55 "mcc_generated_files/lcd.h"
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 55 "mcc_generated_files/lcd.h" 2
# 292 "mcc_generated_files/lcd.h"
...
void LCD_Clear(void);
# 52 "mcc_generated_files/lcd.c" 2
...
void LCD_DisplayOn_NO_2_SYM00Num()
{
 LCDDATA20bits.S19C3 = 1;LCDDATA14bits.S19C2 = 1;LCDDATA8bits.S19C1 = 1;LCDDATA2bits.S19C0 = 1;LCDDATA8bits.S20C1 = 1;LCDDATA20bits.S20C3 = 1;LCDDATA14bits.S20C2 = 1;
}

void LCD_DisplayOff_NO_2_SYM00Num(void)
{
 LCDDATA20bits.S19C3 = 0;LCDDATA14bits.S19C2 = 0;LCDDATA8bits.S19C1 = 0;LCDDATA2bits.S19C0 = 0;LCDDATA8bits.S20C1 = 0;LCDDATA20bits.S20C3 = 0;LCDDATA14bits.S20C2 = 0;
}
...
void LCD_NO_2_SYM00Num (unsigned char num)
{
    switch (num)
    {
        case 0: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 1; LCDDATA20bits.S20C3 = 1; LCDDATA14bits.S20C2 = 0; break;
        case 1: LCDDATA20bits.S19C3 = 0; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 0; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 0; LCDDATA14bits.S20C2 = 0; break;
        case 2: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 0; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 1; LCDDATA20bits.S20C3 = 0; LCDDATA14bits.S20C2 = 1; break;
        case 3: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 0; LCDDATA14bits.S20C2 = 1; break;
        case 4: LCDDATA20bits.S19C3 = 0; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 0; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 1; LCDDATA14bits.S20C2 = 1; break;
        case 5: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 0; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 1; LCDDATA14bits.S20C2 = 1; break;
        case 6: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 0; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 1; LCDDATA20bits.S20C3 = 1; LCDDATA14bits.S20C2 = 1; break;
        case 7: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 0; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 0; LCDDATA14bits.S20C2 = 0; break;
        case 8: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 1; LCDDATA20bits.S20C3 = 1; LCDDATA14bits.S20C2 = 1; break;
        case 9: LCDDATA20bits.S19C3 = 1; LCDDATA14bits.S19C2 = 1; LCDDATA8bits.S19C1 = 1; LCDDATA2bits.S19C0 = 1; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 1; LCDDATA14bits.S20C2 = 1; break;

        default: LCDDATA20bits.S19C3 = 0; LCDDATA14bits.S19C2 = 0; LCDDATA8bits.S19C1 = 0; LCDDATA2bits.S19C0 = 0; LCDDATA8bits.S20C1 = 0; LCDDATA20bits.S20C3 = 0; LCDDATA14bits.S20C2 = 0;
    }
}

void LCD_DisplayOn_NO_1_SYM06Num(void)
{
 LCDDATA21bits.S24C3 = 1;LCDDATA15bits.S24C2 = 1;LCDDATA9bits.S24C1 = 1;LCDDATA3bits.S24C0 = 1;LCDDATA9bits.S25C1 = 1;LCDDATA21bits.S25C3 = 1;LCDDATA15bits.S25C2 = 1;
}

void LCD_DisplayOff_NO_1_SYM06Num(void)
{
 LCDDATA21bits.S24C3 = 0;LCDDATA15bits.S24C2 = 0;LCDDATA9bits.S24C1 = 0;LCDDATA3bits.S24C0 = 0;LCDDATA9bits.S25C1 = 0;LCDDATA21bits.S25C3 = 0;LCDDATA15bits.S25C2 = 0;
}
...
void LCD_NO_1_SYM06Num (unsigned char num)
{
    switch (num)
    {
        case 0: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 1; LCDDATA21bits.S25C3 = 1; LCDDATA15bits.S25C2 = 0; break;
        case 1: LCDDATA21bits.S24C3 = 0; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 0; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 0; LCDDATA15bits.S25C2 = 0; break;
        case 2: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 0; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 1; LCDDATA21bits.S25C3 = 0; LCDDATA15bits.S25C2 = 1; break;
        case 3: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 0; LCDDATA15bits.S25C2 = 1; break;
        case 4: LCDDATA21bits.S24C3 = 0; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 0; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 1; LCDDATA15bits.S25C2 = 1; break;
        case 5: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 0; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 1; LCDDATA15bits.S25C2 = 1; break;
        case 6: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 0; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 1; LCDDATA21bits.S25C3 = 1; LCDDATA15bits.S25C2 = 1; break;
        case 7: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 0; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 0; LCDDATA15bits.S25C2 = 0; break;
        case 8: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 1; LCDDATA21bits.S25C3 = 1; LCDDATA15bits.S25C2 = 1; break;
        case 9: LCDDATA21bits.S24C3 = 1; LCDDATA15bits.S24C2 = 1; LCDDATA9bits.S24C1 = 1; LCDDATA3bits.S24C0 = 1; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 1; LCDDATA15bits.S25C2 = 1; break;

        default: LCDDATA21bits.S24C3 = 0; LCDDATA15bits.S24C2 = 0; LCDDATA9bits.S24C1 = 0; LCDDATA3bits.S24C0 = 0; LCDDATA9bits.S25C1 = 0; LCDDATA21bits.S25C3 = 0; LCDDATA15bits.S25C2 = 0;
    }
}

void LCD_DisplayOn_NO_3_SYM07Num()
{
 LCDDATA18bits.S06C3 = 1;LCDDATA12bits.S06C2 = 1;LCDDATA6bits.S06C1 = 1;LCDDATA0bits.S06C0 = 1;LCDDATA6bits.S07C1 = 1;LCDDATA18bits.S07C3 = 1;LCDDATA12bits.S07C2 = 1;
}

void LCD_DisplayOff_NO_3_SYM07Num()
{
 LCDDATA18bits.S06C3 = 0;LCDDATA12bits.S06C2 = 0;LCDDATA6bits.S06C1 = 0;LCDDATA0bits.S06C0 = 0;LCDDATA6bits.S07C1 = 0;LCDDATA18bits.S07C3 = 0;LCDDATA12bits.S07C2 = 0;
}
...
void LCD_NO_3_SYM07Num (unsigned char num)
{
    switch (num)
    {
        case 0: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 1; LCDDATA18bits.S07C3 = 1; LCDDATA12bits.S07C2 = 0; break;
        case 1: LCDDATA18bits.S06C3 = 0; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 0; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 0; LCDDATA12bits.S07C2 = 0; break;
        case 2: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 0; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 1; LCDDATA18bits.S07C3 = 0; LCDDATA12bits.S07C2 = 1; break;
        case 3: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 0; LCDDATA12bits.S07C2 = 1; break;
        case 4: LCDDATA18bits.S06C3 = 0; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 0; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 1; LCDDATA12bits.S07C2 = 1; break;
        case 5: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 0; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 1; LCDDATA12bits.S07C2 = 1; break;
        case 6: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 0; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 1; LCDDATA18bits.S07C3 = 1; LCDDATA12bits.S07C2 = 1; break;
        case 7: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 0; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 0; LCDDATA12bits.S07C2 = 0; break;
        case 8: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 1; LCDDATA18bits.S07C3 = 1; LCDDATA12bits.S07C2 = 1; break;
        case 9: LCDDATA18bits.S06C3 = 1; LCDDATA12bits.S06C2 = 1; LCDDATA6bits.S06C1 = 1; LCDDATA0bits.S06C0 = 1; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 1; LCDDATA12bits.S07C2 = 1; break;

        default: LCDDATA18bits.S06C3 = 0; LCDDATA12bits.S06C2 = 0; LCDDATA6bits.S06C1 = 0; LCDDATA0bits.S06C0 = 0; LCDDATA6bits.S07C1 = 0; LCDDATA18bits.S07C3 = 0; LCDDATA12bits.S07C2 = 0;
    }
}

void LCD_DisplayOn_NO_4_SYM08Num()
{
 LCDDATA18bits.S01C3 = 1;LCDDATA12bits.S01C2 = 1;LCDDATA6bits.S01C1 = 1;LCDDATA0bits.S01C0 = 1;LCDDATA6bits.S02C1 = 1;LCDDATA18bits.S02C3 = 1;LCDDATA12bits.S02C2 = 1;
}

void LCD_DisplayOff_NO_4_SYM08Num()
{
 LCDDATA18bits.S01C3 = 0;LCDDATA12bits.S01C2 = 0;LCDDATA6bits.S01C1 = 0;LCDDATA0bits.S01C0 = 0;LCDDATA6bits.S02C1 = 0;LCDDATA18bits.S02C3 = 0;LCDDATA12bits.S02C2 = 0;
}
...
void LCD_NO_4_SYM08Num (unsigned char num)
{
    switch (num)
    {
        case 0: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 1; LCDDATA18bits.S02C3 = 1; LCDDATA12bits.S02C2 = 0; break;
        case 1: LCDDATA18bits.S01C3 = 0; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 0; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 0; LCDDATA12bits.S02C2 = 0; break;
        case 2: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 0; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 1; LCDDATA18bits.S02C3 = 0; LCDDATA12bits.S02C2 = 1; break;
        case 3: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 0; LCDDATA12bits.S02C2 = 1; break;
        case 4: LCDDATA18bits.S01C3 = 0; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 0; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 1; LCDDATA12bits.S02C2 = 1; break;
        case 5: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 0; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 1; LCDDATA12bits.S02C2 = 1; break;
        case 6: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 0; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 1; LCDDATA18bits.S02C3 = 1; LCDDATA12bits.S02C2 = 1; break;
        case 7: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 0; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 0; LCDDATA12bits.S02C2 = 0; break;
        case 8: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 1; LCDDATA18bits.S02C3 = 1; LCDDATA12bits.S02C2 = 1; break;
        case 9: LCDDATA18bits.S01C3 = 1; LCDDATA12bits.S01C2 = 1; LCDDATA6bits.S01C1 = 1; LCDDATA0bits.S01C0 = 1; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 1; LCDDATA12bits.S02C2 = 1; break;

        default: LCDDATA18bits.S01C3 = 0; LCDDATA12bits.S01C2 = 0; LCDDATA6bits.S01C1 = 0; LCDDATA0bits.S01C0 = 0; LCDDATA6bits.S02C1 = 0; LCDDATA18bits.S02C3 = 0; LCDDATA12bits.S02C2 = 0;
    }
}

void LCD_DisplayOn_NO_S2_SYM09Num()
{
 LCDDATA19bits.S08C3 = 1;LCDDATA13bits.S08C2 = 1;LCDDATA7bits.S08C1 = 1;LCDDATA1bits.S08C0 = 1;LCDDATA7bits.S09C1 = 1;LCDDATA19bits.S09C3 = 1;LCDDATA13bits.S09C2 = 1;
}

void LCD_DisplayOff_NO_S2_SYM09Num()
{
 LCDDATA19bits.S08C3 = 0;LCDDATA13bits.S08C2 = 0;LCDDATA7bits.S08C1 = 0;LCDDATA1bits.S08C0 = 0;LCDDATA7bits.S09C1 = 0;LCDDATA19bits.S09C3 = 0;LCDDATA13bits.S09C2 = 0;
}
...
void LCD_NO_S2_SYM09Num (unsigned char num)
{
    switch (num)
    {
        case 0: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 1; LCDDATA19bits.S09C3 = 1; LCDDATA13bits.S09C2 = 0; break;
        case 1: LCDDATA19bits.S08C3 = 0; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 0; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 0; LCDDATA13bits.S09C2 = 0; break;
        case 2: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 0; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 1; LCDDATA19bits.S09C3 = 0; LCDDATA13bits.S09C2 = 1; break;
        case 3: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 0; LCDDATA13bits.S09C2 = 1; break;
        case 4: LCDDATA19bits.S08C3 = 0; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 0; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 1; LCDDATA13bits.S09C2 = 1; break;
        case 5: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 0; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 1; LCDDATA13bits.S09C2 = 1; break;
        case 6: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 0; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 1; LCDDATA19bits.S09C3 = 1; LCDDATA13bits.S09C2 = 1; break;
        case 7: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 0; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 0; LCDDATA13bits.S09C2 = 0; break;
        case 8: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 1; LCDDATA19bits.S09C3 = 1; LCDDATA13bits.S09C2 = 1; break;
        case 9: LCDDATA19bits.S08C3 = 1; LCDDATA13bits.S08C2 = 1; LCDDATA7bits.S08C1 = 1; LCDDATA1bits.S08C0 = 1; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 1; LCDDATA13bits.S09C2 = 1; break;

        default: LCDDATA19bits.S08C3 = 0; LCDDATA13bits.S08C2 = 0; LCDDATA7bits.S08C1 = 0; LCDDATA1bits.S08C0 = 0; LCDDATA7bits.S09C1 = 0; LCDDATA19bits.S09C3 = 0; LCDDATA13bits.S09C2 = 0;
    }
}

void LCD_DisplayOn_NO_S1_SYM10Num()
{
 LCDDATA19bits.S10C3 = 1;LCDDATA13bits.S10C2 = 1;LCDDATA7bits.S10C1 = 1;LCDDATA1bits.S10C0 = 1;LCDDATA7bits.S11C1 = 1;LCDDATA19bits.S11C3 = 1;LCDDATA13bits.S11C2 = 1;
}

void LCD_DisplayOff_NO_S1_SYM10Num()
{
 LCDDATA19bits.S10C3 = 0;LCDDATA13bits.S10C2 = 0;LCDDATA7bits.S10C1 = 0;LCDDATA1bits.S10C0 = 0;LCDDATA7bits.S11C1 = 0;LCDDATA19bits.S11C3 = 0;LCDDATA13bits.S11C2 = 0;
}
...
void LCD_NO_S1_SYM10Num (unsigned char num)
{
    switch (num)
    {
        case 0: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 1; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 0; break;
        case 1: LCDDATA19bits.S10C3 = 0; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 0; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 0; LCDDATA13bits.S11C2 = 0; break;
        case 2: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 0; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 1; LCDDATA19bits.S11C3 = 0; LCDDATA13bits.S11C2 = 1; break;
        case 3: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 0; LCDDATA13bits.S11C2 = 1; break;
        case 4: LCDDATA19bits.S10C3 = 0; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 0; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 1; break;
        case 5: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 0; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 1; break;
        case 6: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 0; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 1; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 1; break;
        case 7: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 0; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 0; LCDDATA13bits.S11C2 = 0; break;
        case 8: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 1; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 1; break;
        case 9: LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 1; break;

        default: LCDDATA19bits.S10C3 = 0; LCDDATA13bits.S10C2 = 0; LCDDATA7bits.S10C1 = 0; LCDDATA1bits.S10C0 = 0; LCDDATA7bits.S11C1 = 0; LCDDATA19bits.S11C3 = 0; LCDDATA13bits.S11C2 = 0;
    }
}
void LCD_Clear(void)
{
    ...
    LCDDATA18bits.S00C3 = 0; LCDDATA14bits.S20C2 = 0;
    LCDDATA9bits.S26C1 = 0; LCDDATA1bits.S11C0 = 0;
    LCDDATA3bits.S25C0 = 0; LCDDATA2bits.S20C0 = 0;
    LCDDATA12bits.S00C2 = 0;
    LCDDATA1bits.S09C0 = 0; LCDDATA0bits.S02C0 = 0;
    LCDDATA0bits.S00C0 = 0; LCDDATA1bits.S11C0 = 0; LCDDATA15bits.S26C2 = 0; LCDDATA21bits.S26C3 = 0;
    LCDDATA3bits.S26C0 = 1;
}

void F4_Ad_display(void)
{
    LCDDATA19bits.S10C3 = 1; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 0; LCDDATA7bits.S11C1 = 1; LCDDATA19bits.S11C3 = 1; LCDDATA13bits.S11C2 = 1;
    LCDDATA19bits.S10C3 = 0; LCDDATA13bits.S10C2 = 1; LCDDATA7bits.S10C1 = 1; LCDDATA1bits.S10C0 = 1; LCDDATA7bits.S11C1 = 1; LCDDATA19bits.S11C3 = 0; LCDDATA13bits.S11C2 = 1;
}
